    ...
    <div className={style.wrapper}>
      <nav className="border-green-700 px-2 sm:px-4 py-2.5 rounded bg-gray-50 md:bg-transparent border-b-[0.1px] ">
        <div className="container flex  justify-between items-center mx-auto flex-wrap">
          <a href="/" className="flex items-center scale-[1.1] md:w-[25%]">
            <img
              src={`${screenWidth.width > 1024 ? "/logo1.png" : "/logo1.png"}`}
              className="h-12 md:h-20"
              alt="Flowbite Logo"
            />
          </a>
          <div className=" flex items-center justify-center md:order-2 md:w-[25%]">
            <a
